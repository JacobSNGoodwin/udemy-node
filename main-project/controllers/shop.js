...
const stripe = require("stripe")("sk_test_zvinJzBx1TtVtodWANq9iA3s");
...
exports.getProducts = (req, res, next) => {
  const page = +req.query.page || 1; // convert to number, use page one if no query param
  let totalItems;
...
exports.postOrder = (req, res, next) => {
  ...
  req.user
    ...
    .then(result => {
      // wait until this block to save order id
